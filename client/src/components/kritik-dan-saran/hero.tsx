...
export const KritikDanSaranHero: React.FC = () => {
  return (
    <main className="mx-auto mb-20 mt-32 flex h-fit w-4/5 flex-col-reverse items-center text-slate-50 lg:grid lg:grid-cols-2">
      ...
      <section className="flex cursor-default flex-col justify-center">
        <h1 className="mt-10 hidden text-center text-5xl font-bold leading-tight lg:mt-0 lg:inline lg:text-left">
          {Headline("Bantu Kami Menjadi ", HandleMouseEnter, HandleMouseLeave)}
        </h1>
        <h1 className="mt-10 hidden text-center text-5xl font-bold leading-tight lg:mt-0 lg:inline lg:text-left">
          {Headline("Lebih Baik", HandleMouseEnter, HandleMouseLeave)}
        </h1>
