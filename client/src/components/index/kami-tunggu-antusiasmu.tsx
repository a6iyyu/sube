    ...
    <main className="z-20 h-fit w-full bg-gradient-to-r from-[#161e2c] to-[#222230] pb-40 lg:pb-[7.5rem]">
      <section className="mx-auto flex h-full w-4/5 flex-col items-center text-slate-50">
        ...
        <span className="mt-8 flex gap-x-6">
          <Link to={`/registrasi`}>
            <h4 className="h-fit w-fit rounded-lg bg-[#0000ee] px-8 py-4 font-semibold transition-all duration-300 ease-in-out hover:bg-[#4d4dff]">
              BUAT AKUN
            </h4>
          </Link>
          <Link to={`/masuk`}>
            <h4 className="h-fit w-fit rounded-lg bg-[#393333] px-8 py-4 font-semibold transition-all duration-300 ease-in-out hover:bg-[#4d4d4d]">
              MASUK
            </h4>
          </Link>
        </span>
