...
import { HandleChangeForm, HandleResetPasswordForm } from "~/utils/menangani-lupa-kata-sandi";

export const ResetPasswordForm: React.FC = () => {
  const [XSRFToken, setXSRFToken] = useState<string>("");
  const [errorForm, setErrorForm] = useState<Partial<{ password: string, confirm_password: string }>>({});
