...
export const DaftarKursus: React.FC = () => {
  return (
    <main className="my-40 h-full w-full bg-gradient-to-r from-[#0c0c1e] to-[#141414] [border-radius:45%_55%_10%_10%_/_2.5%_2.5%_0%_0%] lg:[border-radius:20%_20%_10%_10%_/_10%_10%_0%_0%]">
      ...
      <section className="mx-auto mb-14 grid h-full w-4/5 grid-cols-1 grid-rows-1 gap-6 text-slate-50 lg:grid-cols-3 lg:grid-rows-2 lg:gap-y-0">
        {ModulPembelajaran.map(modul =>
          <a href={`/kursus/${modul.judul.replace(/ /g, "-").toLowerCase()}`} className="mt-8 flex h-fit w-fit flex-col transition-all duration-300 ease-in-out">
